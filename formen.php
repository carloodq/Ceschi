...
<body >
  ...
  <div class="pos-f-t">
    ...
    <div class="collapse" id="navbarToggleExternalContent">
      <div class="p-4">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="territorioen.html">Firm</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="prodottien.html">Our Wines</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="diconodinoien.html">Press</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="riconoscimentien.html">Rewards</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="infoen.html">Contacts</font></a>
          </li><br>
    ...
    <div class="dropdown-menu text-center " aria-labelledby="dropdown09">
        <a class="dropdown-item text-center  " href="index.html"><span class="flag-icon flag-icon-it"> </span>  <div class="text-center ">Italiano</div></a>
    </div>
</li><br>
        </ul>
      </div>
...
<img class="img-fluid" src="logo.png" alt="facebook sketch">
  ...
  <div >
    <font color="#2E442D">
  <h2 class="p-4 text-center">Leave us you message</h2>
  </font>
  <form method="post" action="form.php">
    ...
    <div class="form-group">
      <input type="text" class="form-control" id="gnm" placeholder="Last Name" name="cgm">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" id="mtv" placeholder="Subject" name="mtv">
    </div>
    <div class="form-group">
      <input type="text" class="form-control" id="msg" placeholder="Message" name="msg">
    </div>
  <div class="text-center">  <button type="submit" class="btn text-white" style="background-color: #2E442D;">Send</button></div>
  <br><div class="text-center text-success">Message sent</div>
  ...
  <div class="text-center p-4"><p><h4>Stefano Brugnoli's phone:</h4>  <a href="tel:+39 3356432640">+39 3356432640 <img style="max-width:20px" class="img-fluid" src="link.png"></a>  <br> <h4>Claudia Ceschi's phone:</h4> <a href="tel:+39 3491901409">+39 3491901409 <img style="max-width:20px" class="img-fluid" src="link.png"></a>  <br>
  <h4>Email:</h4> <a href="mailto:amaroneceschi@libero.it?Subject=Info%20Request" target="_top">amaroneceschi@libero.it <img style="max-width:20px" class="img-fluid" src="link.png"></a><br>
  <h4>Address:</h4> <a href="https://goo.gl/maps/egJDLgGXaMB1hKnD9">Via T.A.Massa, 44 - 37015 Sant’Ambrogio di Valpolicella -Verona - ITALY <img style="max-width:20px" class="img-fluid" src="link.png"></a></p></div>
  <h2 class="p-4 text-center">Keep in touch</h2>
